 ...
 */
public class RuleToHtmlVisitor extends ANTLRv4ParserBaseVisitor<String> {
    ...
    public String visitParserRuleSpec(@NotNull ParserRuleSpecContext ctx) {
        ...
        buf.append("<table border=\"1\" cellpadding=\"10\" cellspacing=\"10\">");
        buf.append("<tr><td>");
    ...
    public String visitRuleAltList(@NotNull RuleAltListContext ctx) {
        ...
        if (alternatives.size() > 1) {
    		builder.append("<table border=\"1\" cellpadding=\"10\" cellpadding=\"10\" cellspacing=\"10\">");
    		builder.append("<tr>");
